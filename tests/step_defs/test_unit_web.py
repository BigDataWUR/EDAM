...
@given(parsers.parse('EDAM starts with "{input_file}","{metadata_file}" and "{template_file}"'))
def step_impl(input_file, metadata_file, template_file):
    raise NotImplementedError(u'STEP: Given EDAM starts with Yucheng.met,yucheng.yml and yucheng.tmpl')
