...
from edam.utilities.utilities import determine_if_file_is_csv_or_not, StorageType


class Workflow(object):
    def __init__(self, input_list, template_file=None, configuration_file=None,
        ...
        for input_file in input_list:
            ...
            # The same applies to the template_file (template_file ->
            # template_file_data)
            ...
            self.input_data_file, self.template_data_file = determine_if_file_is_csv_or_not(
            ...
            # define the required relationships (via 'relevant_observables'
            # value).
            ...
            # location, though). And all observables are represented with the
            # very same uoms.
            ...
            # try:
            TemplateReader(config=config, input_file=self.input_data_file,
                           template=self.template_data_file)
